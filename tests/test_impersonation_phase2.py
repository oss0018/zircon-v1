...
@pytest.mark.asyncio
async def test_m5_darkweb_no_longer_a_stub():
    """_scan_m5_darkweb should gracefully no-op without INTELX_API_KEY, but
    is no longer an unconditional stub (see TestScanM5Darkweb for full
